...
(function(a) {
    var b = {
        ...
        floatConfig: {
            css: {
                all: "maring:0;padding:0;display:block;visibility:visible;border:none;background:none;float:none;overflow:hidden;",
                main: "position:absolute;z-index:2147483647;",
                cont: "width:100%;height:100%;",
                close: "height:20px;line-height:20px;position:absolute;text-decoration:none;color:#333333;text-align:left;font-size:14px;font-family:simsun,arial;cursor:pointer;background:#fff;filter:alpha(opacity=0);opacity:0;"
            },
            float_xuanfusld_126_360: {
                width: 126,
                height: 360,
                y_r: 1,
                y_d: 150,
                css: {
                    main: "width:126px;height:360px;line-height:360px;",
                    cont: "",
                    close: "width:53px;right:0px;bottom:0px;height:20px;margin-bottom:61px; margin-right:5px;"
                }
            },
            float_xuanfusld_120_270: {
                width: 124,
                height: 299,
                y_r: 1,
                y_d: 150,
                css: {
                    main: "width:124px;height:299px;line-height:299px;",
                    cont: "",
                    close: "width:50px;right:0px;bottom:0px;"
                }
            },
            float_xuanfusld_120_600: {
                width: 124,
                height: 629,
                y_r: 1,
                y_d: 50,
                css: {
                    main: "width:124px;height:629px;line-height:629px;",
                    cont: "",
                    close: "width:50px;right:0px;bottom:0px;"
                }
            },
            float_xuanfubtn_100_100: {
                width: 104,
                height: 129,
                y_r: 0,
                y_d: 40,
                css: {
                    main: "width:104px;height:129px;line-height:129px;",
                    cont: "",
                    close: "width:30px;right:0px;bottom:0px;"
                }
            },
            float_xuanfuwin_300_250: {
                width: 306,
                height: 276,
                y_r: 0,
                y_d: 0,
                css: {
                    main: "width:306px;height:276px;line-height:276px;",
                    cont: "",
                    close: "width:60px;right:0px;top:0px;"
                }
            },
            float_xuanfuwin_250_200: {
                width: 256,
                height: 226,
                y_r: 0,
                y_d: 0,
                css: {
                    main: "width:256px;height:226px;line-height:226px;",
                    cont: "",
                    close: "width:60px;right:0px;top:0px;"
                }
            },
            float_xuanfubtn_120_120: {
                width: 124,
                height: 149,
                y_r: 0,
                y_d: 40,
                css: {
                    main: "width:124px;height:149px;line-height:149px;",
                    cont: "",
                    close: "width:50px;right:0px;bottom:0px;"
                }
            }
        ...
        initialize: function(c) {
            ...
            if (this.BL.checkFloatLu && this.BL.checkFloatLu(this.win) && this.G.BusinessLogic.Distribute.dispatch("floatLu", {
                displayType: "float",
                displayWidth: this.paramSnap.rsi0,
                displayHeight: this.paramSnap.rsi1
            })) {
                if (this.G.BusinessLogic.Distribute.dispatch("floatLuShow", {
                    displayType: "float",
                    displayWidth: this.paramSnap.rsi0,
        ...
        btnCloseOnClick: function(f) {
            ...
            var c = {
                jk: this.jk || "",
                dt: new Date().getTime(),
                rnd: Math.floor(Math.random() * 2147483648)
            };
            try {
        ...
        render: function() {
            ...
            if (this.BL.checkFloatLu && this.BL.checkFloatLu(this.win) && this.G.BusinessLogic.Distribute.dispatch("floatLu", {
                ...
                if (this.G.BusinessLogic.Distribute.dispatch("floatLuShow", {
                    ...
                    t = "float_xuanfusld_126_360"
                }
            }
            var s = this.floatConfig.css;
            var g = this.floatConfig[t];
            var o = g.css;
            var n = g.width;
            var l = g.height;
            var e = document.createElement("div");
            e.style.cssText = s.all + s.main + o.main;
            e.id = this.domId;
            var q = document.createElement("div");
            q.style.cssText = s.all + s.cont + o.cont;
            var c = '<div style="display:none">-</div> <iframe id="{iframeId}"src="http://cpro.baidu.com/cpro/ui/uijs.php?{paramString}" width="{iframeWidth}" height="{iframeHeight}" align="center,center" marginwidth="0"  marginheight="0" scrolling="no" frameborder="0" allowtransparency="true" ></iframe>';
            var f = {
                iframeId: this.iframeId,
                paramString: this.iframeUrl,
                iframeWidth: n,
                iframeHeight: l
            };
            q.innerHTML = this.U.template(c, f);
            e.appendChild(q);
            var d = document.createElement("div");
            d.style.cssText = s.all + s.close + o.close;
            d.innerHTML = "&nbsp;";
            d.onclick = this.U.proxy(this.btnCloseOnClick, this);
            e.appendChild(d);
            this.setPosition(e);
            var m = document.body.children,
                p = m.length,
                r = m.length < 10 ? m.length : 10,
                k = document.body.lastChild;
            for (var j = 0; j < r; j++) {
                var h = m[p - j - 1].getAttribute("data-baidu-dan-id");
                if ( !! h || h === "") {
                    k = m[p - j - 1];
                    break
                }
...
(function(l) {
    ...
    var h = window[j] = function(A) {
        ...
        if (p._isMlt && p._isMlt == 3) {
            ...
            window.BAIDU_CLB_SLOTS_MAP[y] = p;
            if (window.BAIDU_DAN_showAdArray) {
                window.BAIDU_DAN_showAd ? window.BAIDU_DAN_showAd(y, n) : window.BAIDU_DAN_showAdArray.push([y, n])
            } else {
                window.BAIDU_DAN_showAdArray = window.BAIDU_DAN_showAdArray || [];
                window.BAIDU_DAN_showAdArray.push([y, n]);
        ...
        var M = 0;
        i.randomArray.push(Math.random() * 1000000);
        P = i.parseSlotDataFromUnion(A);
        z = i.getSlotDataFromUserOpenApi();
        if (z) {
            M = 1;
            t = f.extend(P, z)
        } else {
        ...
        x = i.Param.getSlot2UIMapping(Q);
        Q = i.Param.mergeSlot2UI(Q, t, x);
        Q.set("js", b);
        if (M) {
            Q.set("c01", 1)
        }
        ...
        var v = Q.get("rsi1");
        var N = Q.get("at");
        if (i.isPreview(O, v, g, N)) {
            window.cpro_template = Q.get("tn").toString();
            window.cpro_w = O.toString();
            window.cpro_h = v.toString();
            for (var B in Q) {
                if (Q[B] && typeof Q[B] === "object" && Q[B].slotParamName) {
                    if (isNaN(Q[B]._value - 0)) {
                        window[Q[B].slotParamName] = Q[B]._value
                    } else {
                        window[Q[B].slotParamName] = Q[B]._value - 0
                    }
                }
            }
            window.cpro_at = Q.at._value;
            var K = document.createElement("script");
            K.type = "text/javascript";
            K.async = true;
            K.src = "http://cpro.baidu.com/cpro/ui/floatPreview.js";
            ...
            var J = parseInt(Q.get("ct"));
            if (J === 2) {
                var C = "bd_close_" + Q.get("tu");
                var u = parseInt(f.getCookieRaw(C));
                if (!isNaN(u)) {
                    if ((u & 1) === 1) {
                        r = true
                    }
            ...
            var E = parseInt(Q.get("fa"));
            if (E === 1 || E === 2) {
                var w = parseInt(Q.get("ls"));
                if ((w === 2 || w === 3) && !q) {
                    Q.set("jk");
                    H = i.Param.serialize(Q);
                    F = i.Param.snap(Q);
                    G = i.getAdsDomId(F.did || parseInt(100 + Math.random() * 1000));
                    l.create(l.UI.FloatAds, {
                        iframeId: G,
                        floatType: E,
                        floatLocation: 2,
                        iframeUrl: H,
                ...
                if ((w === 1 || w === 3) && !r) {
                    Q.set("jk");
                    o = i.Param.serialize(Q);
                    D = i.Param.snap(Q);
                    L = i.getAdsDomId(D.did || parseInt(100 + Math.random() * 1000));
                    l.create(l.UI.FloatAds, {
                        iframeId: L,
                        floatType: E,
                        floatLocation: 1,
